---
title: "2022_AdventOfCode_RMarkdown"
...
# Import data file
# read.csv from utils package uses the header arguemnt 
# and read_csv from readr package uses col_names.
